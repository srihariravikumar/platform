                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="clearfix">
                            ...
                            <div>
                                <h3 style="margin-top:0">{{ $user->name }}&nbsp;</h3> @if(userCan('settings-manage')) <img style="height:25px" src="https://cdn.jsdelivr.net/gh/doctub/static@4.0/favicon.ico"></img> @endif
                                <p class="text-muted">
