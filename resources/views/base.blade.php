...
<head>
    ...
    <link rel="icon" href="https://unpkg.com/doctub@"@if(strpos($version, 'v') !== 0) version @endif {{ $version }}"/images/favicon.png" type="image/x-icon"/>
    <link rel="stylesheet" href="https://unpkg.com/doctub@"@if(strpos($version, 'v') !== 0) version @endif {{ $version }}"/css/core-bundle.css">
