            ...
            <div class="row">
                <div class="col-sm-6 faded">
                    <div class="action-buttons text-left">
                        ...
                        <a style="color:#002bb8" href="https://creativecommons.org/licenses/by-sa/4.0/"><img style="height:10px" src="{{ baseUrl('/images') }}/cc.svg"></img>CC BY-SA 4.0&nbsp;<img src="{{ baseUrl('/images') }}/ntab.svg"</img></a>
                    </div>
                </div>
            </div>
        </div>
