<div class="dropdown-container" dropdown>
    ...
    <ul>
        ...
        <li>
            ...
            <a href="https://github.com/doctub/issues/issues/new" class="text-primary"><i style="color:#e64a19" class="zmdi zmdi-bug zmdi-hc-fw zmdi-hc-lg"></i>Report Bug</a>
        </li>
        <hr>
        ...
        @endif
        <li>
            <a href="https://doctub.github.io/support"><i style="color:#4caf50" class="zmdi zmdi-help zmdi-hc-fw zmdi-hc-lg"></i>Support</a>
